...
function Footer(props)
{
    ...
    <p className=" footerp px-4 py-2  text-center">{props.tex1}<br/> {props.tex2}.</p>
    <Link to="/curr" className="bg-transparent py-2 mb-4 px-4 border btnhome rounded-full text-center"> I'm in </Link>
    </div>
    </div>
