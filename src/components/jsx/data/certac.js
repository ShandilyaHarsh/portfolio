...
const certac = [
  ...
  },
  {
    ...
    desc:
      'Secured a position in top 10 percentile all over India in mental ability conducted by IAW.',
    ims: im5,
  },
  {
    title: 'National talent Search Exam',
    desc:
      'Secured first position in School and a state rank of 124 in talent search exam for mathematics and science.',
    ims: im6,
  },

  {
    ...
    desc:
      'Secured first position in school and a national rank of 1529 in Mathematics and Science olympiad',
    ims: im8,
  },
  {
    title: 'SIP National Prodigy',
    desc:
      'Qualified and secured 3rd runner up position at National Abacus and Mental Arithmetic Test.',
    ims: im7,
  },
];
