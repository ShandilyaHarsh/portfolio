  ...
  return (
    <>
      <div>
        ...
        {showModal ? (
          <>
            <div className="justify-center items-center flex overflow-x-auto md:overflow-x-hidden overflow-y-auto  mt-4 lg:pt-60 fixed inset-0 z-50 outline-none focus:outline-none">
